...
const ChartComponent_1 = () => {
  ...
  useEffect(() => {
    if (chartContainerRef.current) {
      ...
      function getRandomPrice() {
        return lastClose + (0.1 - Math.random() * 0.2);
      }
  ...
  return <div ref={chartContainerRef} style={{ position: 'relative', width: '600px', height: '300px' }} />;
};

export default ChartComponent_1;
